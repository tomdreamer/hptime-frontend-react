    ...
    return (
      <section className="Results">
        ...
        <div class="container text-center">
          <p>
            <a href="#" class="btn btn-primary my-2 ResultMap">Main call to action</a>
            <a href="#" class="btn btn-secondary my-2 ResultMap">Secondary action</a>
          </p>
        </div>
              ...
              <table class="table scrolling">
                  <thead class="thead-light">
                      <tr>
                      <th class="title1Col FCol" scope="col" >Tri/Pertinence</th>
                      <th class="text-center" scope="col" >Sur RDV</th>
                      <th class="text-center" scope="col" >Temps total</th>
                      </tr>
                  </thead>
                  <tbody >
                      ...
                      return (
                          ...
                          <td >
                              <ul class="list-group list-group-flush resultTb FCol">
                                  <li class="list-group-item font-weight-bold ">Nom: {oneStructure.Nom}</li>
                                  <li class="list-group-item">Type: {oneStructure.typeDeStructure}</li>
                              </ul>
                          </td>
                          <td class="cel">
